...
describe("SortableTable", () => {
  ...
  describe("Search Functionality", () => {
    it("calls onSearchChange when typing in search input", async () => {
      ...
      render(<SortableTable {...defaultProps} onSearchChange={mockOnSearchChange} />);
  ...
  describe("Sorting Functionality", () => {
    ...
    it("sorts by population in ascending order", async () => {
      ...
      const populationHeader = screen.getByRole("columnheader", { name: /Population/ });
    ...
    it("shows sort icons only for active column", async () => {
      ...
      const countryHeader = screen.getByRole("columnheader", { name: "Sort by Country ascending" });
  ...
  describe("Accessibility", () => {
    ...
    it("has proper ARIA labels on pagination buttons", () => {
      ...
      expect(screen.getByRole("button", { name: /Go to first page of 3 pages/ })).toBeInTheDocument();
      expect(screen.getByRole("button", { name: /Go to next page, currently on page 1 of 3/ })).toBeInTheDocument();
    });
