...
import { DatasetError, getFilms, type Film } from "./api/getFilms";
...
// ponytail: near-copy of App; lift the request effect into a hook when a third
// page arrives.
const FilmsApp = () => {
